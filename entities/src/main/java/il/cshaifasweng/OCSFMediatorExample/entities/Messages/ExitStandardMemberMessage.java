...
public class ExitStandardMemberMessage implements Serializable {
    ...
    public ExitStandardMemberMessage(String carNumber, String leavingMinutes, String leavingDate
            , String leavingHours, String userId,String park) {
    ...
    public ExitStandardMemberMessage() {
    }
