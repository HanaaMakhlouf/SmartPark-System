...
public class EnterStandardMemberMessage implements Serializable {
    ...
    public EnterStandardMemberMessage(String carNumber, String leavingMinutes, String leavingDate
    ...
    public EnterStandardMemberMessage() {
    }
