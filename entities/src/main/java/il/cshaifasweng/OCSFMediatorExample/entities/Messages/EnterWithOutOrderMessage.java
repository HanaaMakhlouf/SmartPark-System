...
public class EnterWithOutOrderMessage implements Serializable {
    ...
    public EnterWithOutOrderMessage(String carNumber, String leavingMinutes, String leavingDate
    ...
    public EnterWithOutOrderMessage() {
    }
