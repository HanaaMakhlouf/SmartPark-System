...
import il.cshaifasweng.OCSFMediatorExample.client.EnterStandardMemberEvent;
...
public class EnterStandardMember {
    ...
    @Subscribe
    public void enterStandardMember(EnterStandardMemberEvent event) throws IOException {
