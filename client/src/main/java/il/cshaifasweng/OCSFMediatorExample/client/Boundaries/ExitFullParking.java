...
public class ExitFullParking {
    ...
    void Exit(ActionEvent event) throws IOException {
        ...
        ExitFullMemberMessage message = new ExitFullMemberMessage(carNum,leavingMinute, leavingDate1
                , leavingHour, this.memberNumber);
        SimpleClient.getClient().sendToServer(message);
        currentWindow = (Stage) ((Node) event.getSource()).getScene().getWindow();
    }

    @Subscribe
    public void ExitProcess(ExitFullParkingLotEvent event){
    ...
    void back(ActionEvent event) throws IOException {
        ...
        mem.setDateTimeEnd(this.endMemDate);
        mem.setCarNumber(this.carNum);
